...
-- |
data CVPartnerConfig = CVPartnerConfig
...
-- | display the config
instance P.Show CVPartnerConfig where
  show c =
    T.printf
...
-- | constructs a default CVPartnerConfig
--
-- configHost:
--
-- @https://.cvpartner.com@
...
-- @"cvpartner/0.1.0.0"@
--
newConfig :: IO CVPartnerConfig
newConfig = do
    logCxt <- initLogContext
    return $ CVPartnerConfig
        { configHost = "https://.cvpartner.com"
        , configUserAgent = "cvpartner/0.1.0.0"
...
addAuthMethod :: AuthMethod auth => CVPartnerConfig -> auth -> CVPartnerConfig
addAuthMethod config@CVPartnerConfig {configAuthMethods = as} a =
  config { configAuthMethods = AnyAuthMethod a : as}

-- | updates the config to use stdout logging
withStdoutLogging :: CVPartnerConfig -> IO CVPartnerConfig
...
withStderrLogging :: CVPartnerConfig -> IO CVPartnerConfig
...
withNoLogging :: CVPartnerConfig -> CVPartnerConfig
...
data CVPartnerRequest req contentType res accept = CVPartnerRequest
  { rMethod  :: NH.Method   -- ^ Method of CVPartnerRequest
  , rUrlPath :: [BCL.ByteString] -- ^ Endpoint of CVPartnerRequest
  , rParams   :: Params -- ^ params of CVPartnerRequest
  , rAuthTypes :: [P.TypeRep] -- ^ types of auth methods
  }
  deriving (P.Show)

-- | 'rMethod' Lens
rMethodL :: Lens_' (CVPartnerRequest req contentType res accept) NH.Method
rMethodL f CVPartnerRequest{..} = (\rMethod -> CVPartnerRequest { rMethod, ..} ) <$> f rMethod
{-# INLINE rMethodL #-}

-- | 'rUrlPath' Lens
rUrlPathL :: Lens_' (CVPartnerRequest req contentType res accept) [BCL.ByteString]
rUrlPathL f CVPartnerRequest{..} = (\rUrlPath -> CVPartnerRequest { rUrlPath, ..} ) <$> f rUrlPath
{-# INLINE rUrlPathL #-}

-- | 'rParams' Lens
rParamsL :: Lens_' (CVPartnerRequest req contentType res accept) Params
rParamsL f CVPartnerRequest{..} = (\rParams -> CVPartnerRequest { rParams, ..} ) <$> f rParams
{-# INLINE rParamsL #-}

-- | 'rParams' Lens
rAuthTypesL :: Lens_' (CVPartnerRequest req contentType res accept) [P.TypeRep]
rAuthTypesL f CVPartnerRequest{..} = (\rAuthTypes -> CVPartnerRequest { rAuthTypes, ..} ) <$> f rAuthTypes
{-# INLINE rAuthTypesL #-}
...
class HasBodyParam req param where
  setBodyParam :: forall contentType res accept. (Consumes req contentType, MimeRender contentType param) => CVPartnerRequest req contentType res accept -> param -> CVPartnerRequest req contentType res accept
  setBodyParam req xs =
...
class HasOptionalParam req param where
  ...
  applyOptionalParam :: CVPartnerRequest req contentType res accept -> param -> CVPartnerRequest req contentType res accept
  applyOptionalParam = (-&-)
  {-# INLINE applyOptionalParam #-}

  -- | infix operator \/ alias for 'addOptionalParam'
  (-&-) :: CVPartnerRequest req contentType res accept -> param -> CVPartnerRequest req contentType res accept
  (-&-) = applyOptionalParam
  {-# INLINE (-&-) #-}
...
-- ** CVPartnerRequest Utils

_mkRequest :: NH.Method -- ^ Method
          -> [BCL.ByteString] -- ^ Endpoint
          -> CVPartnerRequest req contentType res accept -- ^ req: Request Type, res: Response Type
_mkRequest m u = CVPartnerRequest m u _mkParams []

_mkParams :: Params
_mkParams = Params [] [] ParamBodyNone

setHeader ::
     CVPartnerRequest req contentType res accept
  -> [NH.Header]
  -> CVPartnerRequest req contentType res accept
...
removeHeader :: CVPartnerRequest req contentType res accept -> [NH.HeaderName] -> CVPartnerRequest req contentType res accept
...
_setContentTypeHeader :: forall req contentType res accept. MimeType contentType => CVPartnerRequest req contentType res accept -> CVPartnerRequest req contentType res accept
_setContentTypeHeader req =
    case mimeType (P.Proxy :: P.Proxy contentType) of
        Just m -> req `setHeader` [("content-type", BC.pack $ P.show m)]
        Nothing -> req `removeHeader` ["content-type"]

_setAcceptHeader :: forall req contentType res accept. MimeType accept => CVPartnerRequest req contentType res accept -> CVPartnerRequest req contentType res accept
...
addForm :: CVPartnerRequest req contentType res accept -> WH.Form -> CVPartnerRequest req contentType res accept
addForm req newform =
...
_addMultiFormPart :: CVPartnerRequest req contentType res accept -> NH.Part -> CVPartnerRequest req contentType res accept
...
_setBodyBS :: CVPartnerRequest req contentType res accept -> B.ByteString -> CVPartnerRequest req contentType res accept
_setBodyBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyB body)

_setBodyLBS :: CVPartnerRequest req contentType res accept -> BL.ByteString -> CVPartnerRequest req contentType res accept
_setBodyLBS req body =
    req & L.set (rParamsL . paramsBodyL) (ParamBodyBL body)

_hasAuthType :: AuthMethod authMethod => CVPartnerRequest req contentType res accept -> P.Proxy authMethod -> CVPartnerRequest req contentType res accept
...
class P.Typeable a =>
  ...
  applyAuthMethod
    ...
    -> a
    -> CVPartnerRequest req contentType res accept
    -> IO (CVPartnerRequest req contentType res accept)
...
_applyAuthMethods
  ...
  -> CVPartnerConfig
  -> IO (CVPartnerRequest req contentType res accept)
_applyAuthMethods req config@(CVPartnerConfig {configAuthMethods = as}) =
  foldlM go req as
  where
