## OpenAPI Auto-Generated [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) Bindings to `CVPartner`

The library in `lib` provides auto-generated-from-OpenAPI [http-client](https://www.stackage.org/lts-10.0/package/http-client-0.5.7.1) bindings to the CVPartner API.
...
| baseModule                      | Set the base module namespace                                                                                                 |          | CVPartner                      |
| cabalPackage                    | Set the cabal package name, which consists of one or more alphanumeric words separated by hyphens                             |          | cvpartner                    |
...
| configType                      | Set the name of the type used for configuration                                                                               |          | CVPartnerConfig                      |
...
| requestType                     | Set the name of the type used to generate requests                                                                            |          | CVPartnerRequest                     |
...
| MODULE              | NOTES                                               |
| ------------------- | --------------------------------------------------- |
| CVPartner.Client    | use the "dispatch" functions to send requests       |
| CVPartner.Core      | core functions, config and request types            |
| CVPartner.API       | construct api requests                              |
| CVPartner.Model     | describes api models                                |
| CVPartner.MimeTypes | encoding/decoding MIME types (content-types/accept) |
| CVPartner.ModelLens | lenses for model fields                             |
| CVPartner.Logging   | logging functions and utils                         |
